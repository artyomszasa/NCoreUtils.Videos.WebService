...
#pragma warning restore IDE0060
        ...
        string? S(string name)
            => query.TryGetValue(name, out var values) && values.Count > 0 ? values[0] : default;
    ...
    public static async Task InvokeAnalyze(HttpRequest request, HttpResponse response, IResourceFactory resourceFactory, IVideoAnalyzer analyzer, CancellationToken cancellationToken)
    {
